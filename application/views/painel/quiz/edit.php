				...
				<div class="row">
					...
					<div class="row mb-5">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
								<form id="cad_quiz" name="cad_quiz" method="POST" action="saveEdit" enctype="multipart/form-data" >
									...
									<div class="row pb-5">
										...
										<div class="form-group mb-3">
											...
											<input type="text" class="form-control uppercase" name="name"  id="name" placeholder="Mínimo de 3 caracteres" required value="<?php echo $quiz['name'] ?>">
												<input type="hidden" name="name_qtd"  id="name_qtd">
												<input type="hidden" name="id_quiz"  id="id_quiz" value="<?php echo $quiz['id_quiz'] ?>">
											</div>
										</div>
										</div>
									</div>
									...
									<div class="row pb-5">
										...
										<div class="form-group mb-3">
											...
											<div class="input-group">
												<textarea id="description" name="description" rows="15"><?php echo $quiz['description'] ?></textarea>
									...
									<div class="row pb-5">
										...
										<div class="col-md-10" style="margin-top:13.5px">
											...
											<br>
									<input class="btn btn-success active form-control uppercase"  type="submit" id="cadastrar" name="cadastrar" value="Confirmar" style="margin-bottom:50px" />
										</div>
